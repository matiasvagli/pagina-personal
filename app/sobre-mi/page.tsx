      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-lg leading-relaxed">
              Desarrollador Backend especializado en el ecosistema Python, con experiencia progresiva desde <strong>2020</strong> en el desarrollo de APIs, automatización de procesos, integración de servicios y diseño de sistemas backend orientados al negocio. Trabajo principalmente con <strong>Django</strong>, <strong>FastAPI</strong> y <strong>PostgreSQL</strong>, priorizando la calidad, la escalabilidad y las buenas prácticas.
            </p>
            <p className="text-lg leading-relaxed">
              Tengo experiencia real colaborando con PyMEs y en proyectos freelance, así como en la construcción de APIs y microservicios utilizando FastAPI, Django, SQL y Docker. Me interesa especialmente el diseño de software y la aplicación de buenas prácticas: arquitectura hexagonal, principios SOLID, modularidad y Domain-Driven Design (DDD), buscando siempre crear sistemas mantenibles, escalables y fáciles de testear.
            </p>
            <p className="text-lg leading-relaxed">
              Soy creador de <strong>CRUDfull</strong>, una herramienta CLI open source que genera proyectos y recursos CRUD completos en FastAPI (modelos, esquemas, servicios, routers, tests y entorno Docker), pensada para acelerar el desarrollo sin perder estructura ni calidad.
            </p>
            <p className="text-lg leading-relaxed">
              Además del stack Python, tengo experiencia práctica con JavaScript y TypeScript en el desarrollo de APIs. Actualmente estoy aprendiendo Go, profundizando en concurrencia y performance para ampliar mi stack y fortalecer mi perfil backend.
            </p>
            <p className="text-lg leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-white/10 rounded-lg p-4 bg-white/[0.02]">
              <h3 className="text-lg font-semibold mb-1">Arquitectura Hexagonal</h3>
              <p className="text-neutral-400 text-sm">Codely (2025)</p>
            </div>
            <div className="border border-white/10 rounded-lg p-4 bg-white/[0.02]">
