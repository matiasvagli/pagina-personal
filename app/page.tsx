...
const profile = {
  ...
  resumen:
    "Desarrollo y escalo backends en Python (Django/FastAPI), JavaScript y TypeScript, diseño bases de datos (PostgreSQL/MySQL/MongoDB) y microservicios, automatizo despliegues con Docker. Experiencia con PyMEs y proyectos reales de negocio.",
